...
def load_skills_block_template() -> str:
    ...
    Per-skill bullets follow this template in
    ``system_prompt.py``.
    """
...
def load_bot_replies() -> dict[str, str]:
    ...
    does not interpolate; callers do, e.g.::
        ...
        await update.effective_message.reply_text(
            replies["unprivileged_contact"].format(
                contact_name=contact.name, delivery_address=chat_id,
            ),
        )

...
CREATE TABLE IF NOT EXISTS `agent_turns_cache` (
...
CREATE UNIQUE INDEX IF NOT EXISTS `agent_turns_cache_sequence` ON `agent_turns_cache` (`turn_id`,`sequence`);
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `agent_turns_cache_job` ON `agent_turns_cache` (`job_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `agent_turns_cache_turn` ON `agent_turns_cache` (`turn_id`,`id`);

...
1. Reads the Task row (and the operator's Contact row for
   ...
   :mod:`magi.tools.tasks.schedule`); the runner
...
3. Lets the agent's :class:`magi.tools.comms.send_message
...
from magi.bus.jobs.protocols.session import SessionMessage, new_session_id

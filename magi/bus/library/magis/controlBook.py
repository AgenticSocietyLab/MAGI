...
Schema for the control-plane runtime registry tables.
bus's ControlBook preserves the original `RuntimeDesiredState` /
`RuntimeObservedState` enums (string-backed).
"""

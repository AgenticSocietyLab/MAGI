...
class Contact:
    ...
    def to_dict(self) -> dict:
        ...
        Mirrors the old bus's ``ContactView`` field names
        ...
        :func:`~magi.new_bus.library.base.to_iso`.
        """
        return asdict(self)
...
class ContactNote:
    ...
    def to_dict(self) -> dict:
        ...
        Mirrors the old bus's ``NoteView`` field names so
...
class ContactNoteBook(BaseBook[_ContactNoteRow, ContactNote]):
    ...
    def update_note(self, *, note_id: int, note: str) -> ContactNote:
        ...
        not resolve — same exception the old bus raised so
    ...
    def delete_note(self, *, note_id: int) -> bool:
        ...
        no row matched. Mirrors the old bus's

...
:meth:`magi.startup.orchestrator_service.create_app` per plan §20.4.
"""
...
def test_orchestrator_rejects_missing_hmac(monkeypatch):
    from magi.startup.orchestrator_service import _verify_request
...
def test_control_plane_exposes_magis_provision_route():
    from magi.startup.orchestrator_service import create_app

...
test("a newer release asset is chosen for this machine", () => {
  ...
  assert.equal(
    releaseDownloadUrl("https://github.com/AgenticSocietyLab/MAGI.git", asset.browser_download_url),
    true,
  );
  assert.equal(
    releaseDownloadUrl("https://github.com/AgenticSocietyLab/MAGI.git", "https://example.com/MAGI.dmg"),
    false,
  );
});

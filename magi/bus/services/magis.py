...
class MagisService:
    ...
    def create_role_in_magis(
        ...
        if name in RESERVED_ROLE_NAMES:
            raise ValueError("Adam and EVE are reserved role names")
        with open_magis_session() as session:
    ...
    # ------------------------------------------------------------------
    # Membership CRUD with Adam/EVE-role side-effects.
    # ------------------------------------------------------------------
